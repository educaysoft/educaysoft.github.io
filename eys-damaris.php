 ...
 <div style="float:left; width:60%; margin:60px auto; padding:1vw">
  ...
  <div style="width: 100%; height:100%;" >
           <div  style="text-align:justify; font-size: 20px;">
                   <p class="eys-parrafo">Soy Damaris Margarita  Miranda Bolaños , tengo 25 años soy oriunda del Cantón Esmeraldas, cuidad de Esmeraldas en el barrio Mina de Piedra sector de Aire libre Alto, mis padres son Mariano Miranda Y Soraya Bolaños y tengo 4 hermanos varones que son Geovanny, Rubén ,Samuel y Josué. </p>
                   <p class="eys-parrafo">  Desde muy pequeña he sido formada en una familia con principios cristianos.  </p>
   <div id="blog-seccion2"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mis estudios</h2> 
                   ...
                   <p class="eys-parrafo">Mis estudios secundarios los realice en el colegio Tecnico Luis Vargas Torres. Mis estudios de tercer nivel los estoy realizando en la Universidad Tecnica Luis Vargas Torres donde ha sido mi formación para abrir camino en el ambito laboral..</p>

   <div id="blog-seccion3"  style="height: 50px;"></div>

    <h2 style="border-bottom: 1px solid green;"> Mi perfil informático </h2> 
    <p class="eys-parrafo">Soy futura ingeniera en sistemas informaticos y estoy inmersa en el ambito del desarrollo web.</p>
   ...
   <div id="blog-seccion4"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mis Hooby la música y la programación web .</h2> 
    

                   <p   class="eys-parrafo">En mis ratos libres me gusta hacer contenido digital en mi página de facebook aparte de dedicarme a mis estudios me gusta entonar piano y cantar en mi iglesia....</p>
